...
?>
<h2><?php esc_html_e('Partial Payments Summary','Advanced Partial Payment and Deposit For Woocommerce'); ?></h2>
...
<div style="margin-bottom: 40px;">
    <table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
        ...
        <tr>
            <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e('Payment','Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
            <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e('Payment ID','Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
            <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e('Status','Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
            <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e('Amount','Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
