 ...
 *
 * @package MagePeople\WCDP\Templates\Plain
 * @version 4.0.15
 */
...
echo "\n****************************************************\n\n";
esc_html_e('Partial Payments Summary','Advanced Partial Payment and Deposit For Woocommerce')."\n";
echo "\n****************************************************\n\n";
...
foreach($schedule as $timestamp => $payment){
    ...
    echo esc_html__('Payment','Advanced Partial Payment and Deposit For Woocommerce') .": ".esc_html__($date)."\n" ;
    echo esc_html__('Payment ID','Advanced Partial Payment and Deposit For Woocommerce') .": ".esc_html__($payment_id)."\n" ;
    echo esc_html__('Status','Advanced Partial Payment and Deposit For Woocommerce') .": ".esc_html__($status)."\n" ;
    echo esc_html__('Amount','Advanced Partial Payment and Deposit For Woocommerce') .": ".strip_tags($amount,$price_args)."\n";
