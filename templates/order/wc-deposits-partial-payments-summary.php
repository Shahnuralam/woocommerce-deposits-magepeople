...
?> <h2 class="woocommerce-column__title"> <?php echo esc_html__('Partial payments summary', 'Advanced Partial Payment and Deposit For Woocommerce') ?></h2>
...
<table class="woocommerce-table  woocommerce_deposits_parent_order_summary">
    ...
    <tr>
        ...
        <th ><?php echo esc_html__('Payment ID', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                ...
                foreach ($documents as $document) {
                    ...
                    if ($document->is_enabled() && $document->get_type() === 'partial_payment_invoice') {
                        ...
                        if ( $invoice_allowed ) {
                            ...
                            $link .= esc_html__('PDF Invoice', 'Advanced Partial Payment and Deposit For Woocommerce') . '</a>';
