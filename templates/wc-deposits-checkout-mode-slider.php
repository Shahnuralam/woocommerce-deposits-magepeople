        ...
        <div id='<?php echo $basic_buttons ? 'basic-wc-deposits-options-form' : 'wc-deposits-options-form'; ?>'>
            ...
            <div class="<?php echo $hide? 'wcdp_hidden ':'' ?>  <?php echo $basic_buttons ? 'basic-switch-Advanced Partial Payment and Deposit For Woocommerce' : 'deposit-options switch-toggle switch-candy switch-Advanced Partial Payment and Deposit For Woocommerce'; ?>">
                ...
                <label id="pay-deposit-label"
                       for='pay-deposit'><?php echo esc_html__($deposit_text, 'Advanced Partial Payment and Deposit For Woocommerce'); ?></label>
                ...
                <?php if (isset($force_deposit) && $force_deposit === 'yes') { ?>
                    ...
                    <label id="pay-full-amount-label" for='pay-full-amount'
                           onclick=''><?php echo esc_html__($full_text, 'Advanced Partial Payment and Deposit For Woocommerce'); ?></label>
                <?php } else { ?>
                                ...
                                <strong>
                                    ...
                                    if ($selected_plan == $plan_id) {
                                        ...
                                        <span> <a data-expanded="no"
                                                  data-view-text="<?php echo esc_html__('View details', 'Advanced Partial Payment and Deposit For Woocommerce'); ?>"
                                                  data-hide-text="<?php echo esc_html__('Hide details', 'Advanced Partial Payment and Deposit For Woocommerce'); ?>"
                                                  data-id="<?php echo $plan_id; ?>"
                                                  class="wcdp-view-plan-details"><?php echo esc_html__('View details', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></a>
                                        </span>
