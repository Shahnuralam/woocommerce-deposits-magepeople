...
if (!class_exists('WC_Deposits_Email_Customer_Deposit_Paid')) :
    ...
    class WC_Deposits_Email_Customer_Deposit_Paid extends WC_Email
    {
        ...
        function __construct()
        {
            ...
            $this->title = esc_html__('Deposit Payment Received', 'Advanced Partial Payment and Deposit For Woocommerce');
            $this->customer_email = true;

            $this->description = esc_html__('This is an order notification sent to the customer after deposit is paid, containing order details and a link to pay the remaining balance.', 'Advanced Partial Payment and Deposit For Woocommerce');
        ...
        public function trigger($order_id, $order = false)
        {
            ...
            if ($order) {
                ...
                if(!$this->partial_payment) {
                    ...
                    $payments = wcdp_get_order_partial_payments($order->get_id(), array(
                        'meta_query' => array(
                ...
                $this->object->update_meta_data('_wcdp_current_payment',$this->partial_payment->get_id());
                if (in_array($this->object->get_status(), wcdp_valid_parent_statuses_for_partial_payment()) && get_option('wc_deposits_remaining_payable', 'yes') === 'yes') {
                ...
                $this->object->delete_meta_data('_wcdp_current_payment');
        ...
        {
            return esc_html__('Your {site_title} order receipt from {order_date}', 'Advanced Partial Payment and Deposit For Woocommerce');
        }
        ...
        {
            return esc_html__('Thank you for your order', 'Advanced Partial Payment and Deposit For Woocommerce');
        }

        public function get_default_email_text()
        {
            return esc_html__("Your deposit has been received and your order is now being processed. Your order details are shown below for your reference:", 'Advanced Partial Payment and Deposit For Woocommerce');

        }

        public function get_default_payment_text()
        {
            return esc_html__('To pay the remaining balance, please visit this {wcdp_payment_link}', 'Advanced Partial Payment and Deposit For Woocommerce');
        }
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = array(
                ...
                'email_text' => array(
                    ...
                    'description' => esc_html__('Text to appear as email content message', 'Advanced Partial Payment and Deposit For Woocommerce') . ' ' . $placeholder_text,
                ...
                'additional_content' => array(
                    ...
                    'description' => esc_html__('Text to appear below the main email content.', 'woocommerce') . ' ' . $placeholder_text . ' {wcdp_payment_link}',
