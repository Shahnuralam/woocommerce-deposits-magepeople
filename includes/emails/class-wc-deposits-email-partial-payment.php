...
if (!class_exists('WC_Deposits_Email_Partial_Payment')):
    ...
    class WC_Deposits_Email_Partial_Payment extends WC_Email
    {
        ...
        function __construct()
        {
            ...
            $this->title = esc_html__('Partial Payment', 'Advanced Partial Payment and Deposit For Woocommerce');
            $this->description = esc_html__('Partial payment emails are sent when an order is partially paid.', 'Advanced Partial Payment and Deposit For Woocommerce');

            $this->heading = esc_html__('Order partially paid', 'Advanced Partial Payment and Deposit For Woocommerce');
            $this->subject = esc_html__('[{site_title}] Order partially paid ({order_number}) - {order_date}', 'Advanced Partial Payment and Deposit For Woocommerce');
