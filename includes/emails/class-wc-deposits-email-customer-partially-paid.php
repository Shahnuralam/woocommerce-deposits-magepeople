...
if (!class_exists('WC_Deposits_Email_Customer_Partially_Paid')) :
    ...
    class WC_Deposits_Email_Customer_Partially_Paid extends WC_Email
    {
        ...
        function __construct()
        {
            ...
            $this->title = esc_html__('Partial Payment Received', 'Advanced Partial Payment and Deposit For Woocommerce');
            $this->customer_email = true;

            $this->description = esc_html__('This is an order notification sent to the customer after any partial payment (except deposit) is paid, containing order details and a link to pay the remaining balance if order is not fully paid yet.', 'Advanced Partial Payment and Deposit For Woocommerce');
        ...
        {
            return esc_html__('Thank you for your payment', 'Advanced Partial Payment and Deposit For Woocommerce');
        }

        public function get_default_email_text()
        {
            return esc_html__("Your payment {partial_payment_number} has been received. Your order details are shown below for your reference:", 'Advanced Partial Payment and Deposit For Woocommerce');
