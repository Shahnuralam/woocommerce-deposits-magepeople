...
class WC_Deposits_Checkout
{
    ...
    public function enqueue_scripts()
    {
        ...
        $message_deposit = wp_kses(__(get_option('wc_deposits_message_deposit'), 'Advanced Partial Payment and Deposit For Woocommerce'), $allowed_html);
        $message_full_amount = wp_kses(__(get_option('wc_deposits_message_full_amount'), 'Advanced Partial Payment and Deposit For Woocommerce'), $allowed_html);
    ...
    public function checkout_deposit_button()
    {
        ...
        $deposit_text = esc_html__(get_option('wc_deposits_button_deposit'), 'Advanced Partial Payment and Deposit For Woocommerce');
        $full_text = esc_html__(get_option('wc_deposits_button_full_amount'), 'Advanced Partial Payment and Deposit For Woocommerce');
        $deposit_option_text = esc_html__(get_option('wc_deposits_deposit_option_text'), 'Advanced Partial Payment and Deposit For Woocommerce');

        $post_data = array();

        if ($deposit_text === false) {

            $deposit_text = esc_html__('Pay Deposit', 'Advanced Partial Payment and Deposit For Woocommerce');

        }
        if ($full_text === false) {
            $full_text = esc_html__('Full Amount', 'Advanced Partial Payment and Deposit For Woocommerce');

        }

        if ($deposit_option_text === false) {
            $deposit_option_text = esc_html__('Deposit Option', 'Advanced Partial Payment and Deposit For Woocommerce');
        }
  ...
  public function review_order_after_order_total()
{
    ...
    if ($display) {
        ...
        $to_pay_text = esc_html__(get_option('wc_deposits_to_pay_text', esc_html__('To Pay', 'Advanced Partial Payment and Deposit For Woocommerce')), 'Advanced Partial Payment and Deposit For Woocommerce');
        $future_payment_text = esc_html__(get_option('wc_deposits_second_payment_text', esc_html__('Future Payments', 'Advanced Partial Payment and Deposit For Woocommerce')), 'Advanced Partial Payment and Deposit For Woocommerce');
    ...
    function checkout_update_order_meta($order)
    {
        ...
        if (isset(WC()->cart->deposit_info['deposit_enabled']) && WC()->cart->deposit_info['deposit_enabled'] === true) {
            ...
            $deposit_data = array(
                'id' => '',
                'title' => esc_html__('Deposit', 'Advanced Partial Payment and Deposit For Woocommerce'),
                'type' => 'deposit',
