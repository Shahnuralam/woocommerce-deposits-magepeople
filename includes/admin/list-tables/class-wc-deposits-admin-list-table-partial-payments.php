...
if ( class_exists( 'WC_Deposits_Admin_List_Table_Partial_Payments', false ) ) {
    return;
}
...
/**
 * WC_Deposits_Admin_List_Table_Partial_Payments Class.
 */
class WC_Deposits_Admin_List_Table_Partial_Payments extends WC_Admin_List_Table {
     ...
     * @var string
     */
    protected $list_table_type = 'wcdp_payment';
    ...
    protected function render_blank_state() {
        ...
        echo '<h2 class="woocommerce-BlankState-message">' . esc_html__( 'No partial payments found.', 'Advanced Partial Payment and Deposit For Woocommerce' ) . '</h2>';
    ...
    public function define_columns( $columns ) {
        ...
        $show_columns['order_number']     = esc_html__( 'Partial Payment', 'Advanced Partial Payment and Deposit For Woocommerce' );
        ...
        $show_columns['wcdp_parent_order']       = esc_html__( 'Order', 'woocommerce' );
    ...
    /**
     *  Render column: wcdp_parent_order.
     */
    protected function render_wcdp_parent_order_column() {
    ...
    public function bulk_admin_notices() {
        ...
        if ( 'edit.php' !== $pagenow || 'wcdp_payment' !== $post_type || ! isset( $_REQUEST['bulk_action'] ) ) { // WPCS: input var ok, CSRF ok.
            return;
        }
    ...
    public function search_label( $query ) {
        ...
        if ( 'edit.php' !== $pagenow || 'wcdp_payment' !== $typenow || ! get_query_var( 'wcdp_payment_search' ) || ! isset( $_GET['s'] ) ) { // phpcs:disable  WordPress.Security.NonceVerification.NoNonceVerification
            return $query;
        }
    ...
    public function add_custom_query_var( $public_query_vars ) {
        $public_query_vars[] = 'wcdp_payment_search';
    ...
    public function search_custom_fields( $wp ) {
        ...
        if ( 'edit.php' !== $pagenow || empty( $wp->query_vars['s'] ) || 'wcdp_payment' !== $wp->query_vars['post_type'] || ! isset( $_GET['s'] ) ) { // phpcs:disable  WordPress.Security.NonceVerification.NoNonceVerification
            return;
        }
        ...
        if ( ! empty( $post_ids ) ) {
            ...
            $wp->query_vars['wcdp_payment_search'] = true;
