...
class WC_Deposits_Admin_Product
{
    ...
    public function tab_options_tab()
    {
        ...
        <li class="deposits_tab"><a
                href="#deposits_tab_data"><?php echo esc_html__('Deposit', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></a>
        </li><?php
    ...
    public function tab_options()
    {
        ...
        if (wcdp_checkout_mode()) {
            ...
            <div id="deposits_tab_data" class="panel woocommerce_options_panel">
                ...
                <h3> <?php echo esc_html__('Checkout Mode enabled', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h3>
                <p><?php echo esc_html__('If you would like to collect deposit on product basis , please disable Checkout mode. ', 'Advanced Partial Payment and Deposit For Woocommerce') ?>
                    <a
                            href="<?php echo get_admin_url(null, '/admin.php?page=wc-settings&tab=wc-deposits'); ?>"> <?php echo esc_html__('Go to plugin settings', 'Advanced Partial Payment and Deposit For Woocommerce') ?> </a>
                </p>
            ...
            <div class="options_group">
                <p class="form-field">
                    <?php woocommerce_wp_select(array(
                        ...
                        'label' => esc_html__('Inherit store-wide Settings', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'options' => array(
                        ...
                        'description' => esc_html__('Enable this to Inherit store-wide deposit settings ', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'desc_tip' => true));
                    ?>
                </p>
            </div>
            ...
            <div class="<?php echo $inherit ? 'hidden' : ''; ?>  wcdp_deposit_values options_group">
                <p class="form-field">
                    <?php woocommerce_wp_select(array(
                        ...
                        'label' => esc_html__('Enable deposit', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'description' => esc_html__('Enable this to require a deposit for this item.', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'desc_tip' => true));
                    ?>
                    <?php woocommerce_wp_select(array(
                        ...
                        'label' => esc_html__('Force deposit', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'description' => esc_html__('If you enable this, the customer will not be allowed to make a full payment.', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'desc_tip' => true));
                    ?>
                </p>
                <p class="form-field">
                    ...
                    <?php woocommerce_wp_select(array(
                        ...
                        'label' => esc_html__('Deposit type', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'options' => array(
                            'fixed' => esc_html__('Fixed value', 'Advanced Partial Payment and Deposit For Woocommerce'),
                            'percent' => esc_html__('Percentage of price', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    ...
                    <?php woocommerce_wp_text_input(array(
                        ...
                        'label' => esc_html__('Deposit Amount', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'description' => wp_kses(__('This is the minimum deposited amount.<br/>Note: Tax will be added to the deposit amount you specify here.',
                            'Advanced Partial Payment and Deposit For Woocommerce'), array('br' => array())),
                        'type' => 'number',
                        'desc_tip' => true,
                    ...
                    woocommerce_wp_select(array(
                        ...
                        'label' => esc_html__('Payment plan(s)', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'description' => esc_html__('Selected payment plan(s) will be available for customers to choose from', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    ...
                    <div class="options_group">
                        <p class="form-field">
                            <?php woocommerce_wp_checkbox(array(
                                ...
                                'label' => esc_html__('Multiply by persons', 'Advanced Partial Payment and Deposit For Woocommerce'),
    ...
    public function add_reminder_meta_box()
    {
        ...
        if ($product) {
            add_meta_box('wc_deposits_second_payment_reminder',
                esc_html__('Partial Payment Reminder', 'Advanced Partial Payment and Deposit For Woocommerce'),
    ...
    function wc_deposits_second_payment_reminder()
    {
        ...
        <p>
            <b><?php echo esc_html__('If you would like to send out second payment reminder emails to all orders containing this product on a specific date in the future, set a date below.', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></b>
        </p>
        <p> <?php echo esc_html__('Next Reminder Date :', 'Advanced Partial Payment and Deposit For Woocommerce') ?> <input type="text"
    ...
    public function product_bulk_edit_end()
    {
        ?>
        <label>
            <h4><?php echo esc_html__('Deposit Options', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h4>
        </label>
        <label>
            <span class="title"><?php echo esc_html__('Inherit Storewide Settings ?', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
        ...
        <label>
            <span class="title"><?php echo esc_html__('Enable Deposit ?', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
            <span class="input-text-wrap">
        ...
        <label>
            <span class="title"><?php echo esc_html__('Force Deposit?', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
            <span class="input-text-wrap">
            <select class="force_deposit" name="_force_deposit">
            <?php
            $options = array(
                '' => esc_html__('— No Change —', 'Advanced Partial Payment and Deposit For Woocommerce'),
                'yes' => esc_html__('Yes', 'Advanced Partial Payment and Deposit For Woocommerce'),
                'no' => esc_html__('No', 'Advanced Partial Payment and Deposit For Woocommerce')
            );
            foreach ($options as $key => $value) {
        ...
        <label>
            <span class="title"><?php echo esc_html__('Multiply By Persons?', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
            <span class="input-text-wrap">
        ...
        <label>
            <span class="title"><?php echo esc_html__('Deposit Type?', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
            <span class="input-text-wrap">
        ...
        <div class="inline-edit-group">
            <label class="alignleft">
                <span class="title"><?php echo esc_html__('Deposit Amount', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
                <span class="input-text-wrap">
            <select class="change_deposit_amount change_to" name="change_deposit_amount">
            <?php
            $options = array(
                '' => esc_html__('— No Change —', 'Advanced Partial Payment and Deposit For Woocommerce'),
                '1' => esc_html__('Change to:', 'Advanced Partial Payment and Deposit For Woocommerce'),
                '2' => esc_html__('Increase by (fixed amount or %):', 'Advanced Partial Payment and Deposit For Woocommerce'),
                '3' => esc_html__('Decrease by (fixed amount or %):', 'Advanced Partial Payment and Deposit For Woocommerce')
            );
            foreach ($options as $key => $value) {
            ...
            <label class="change-input">
                <input style="margin-left:5.4em;" type="text" name="_deposit_amount" class="text deposit_amount"
                       placeholder="<?php echo sprintf(esc_html__('Enter Deposit Amount (%s)', 'Advanced Partial Payment and Deposit For Woocommerce'), get_woocommerce_currency_symbol()); ?>"
                       value=""/>
            </label>
        </div>
        ...
        <div class="inline-edit-group">
            <label class="alignleft">
                <span class="title"><?php echo esc_html__('Payment Plans', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span>
                <span class="input-text-wrap">
    ...
    function variation_override($loop, $variation_data, $variation)
    {
        ...
        <hr/>
        <strong><span> <?php echo esc_html__('Deposit settings', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></span></strong>
        </p>
        <?php
        ...
        woocommerce_wp_checkbox(array(
            ...
            'style' => 'float:left;',
            'label' => esc_html__('Override product deposits options', 'Advanced Partial Payment and Deposit For Woocommerce'),
            'description' => esc_html__('Enable to override deposit settings of parent', 'Advanced Partial Payment and Deposit For Woocommerce'),
            'desc_tip' => true));
        ?>
        ...
        'description' => esc_html__('If you enable this, the customer will not be allowed to make a full payment.',
            'Advanced Partial Payment and Deposit For Woocommerce'), 'desc_tip' => true));
        ?>
