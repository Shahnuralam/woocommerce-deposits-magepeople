...
class WC_Deposits_Taxonomies
{
    ...
    function register_payment_plan_taxonomy()
    {
        ...
        register_taxonomy(WC_DEPOSITS_PAYMENT_PLAN_TAXONOMY,
            array('product'),
            array(
                'label' => esc_html__('Payment plans', 'Advanced Partial Payment and Deposit For Woocommerce'),
                'labels' => array(
                    'name' => esc_html__('Payment plans', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'singular_name' => esc_html__('Payment plan', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'menu_name' => esc_html__('Payment plans', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'search_items' => esc_html__('Search plans', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'all_items' => esc_html__('All plans', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'edit_item' => esc_html__('Edit plan', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'update_item' => esc_html__('Update plan', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'add_new_item' => esc_html__('Add new plan', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'new_item_name' => esc_html__('New plan name', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'add_or_remove_items' => esc_html__('Add or remove plans', 'Advanced Partial Payment and Deposit For Woocommerce'),
                    'not_found' => esc_html__('No plans found', 'Advanced Partial Payment and Deposit For Woocommerce'),
                ),
                'capabilities' => array(
    ...
    function payment_plan_table($tag)
    {
        ...
        <hr/>
        <h3> <?php echo esc_html__('Plan schedule', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h3>
        <br/>
        <table class="widefat striped" data-populate='<?php echo $payment_details; ?>' id="payment_plan_details">
            ...
            <tr>
                <th>&nbsp;</th>
                <th><?php echo esc_html__('Amount', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></th>
                <th colspan="2"> <?php echo esc_html__('Set date', 'Advanced Partial Payment and Deposit For Woocommerce'); ?>
                    / <?php echo esc_html__('After', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2"><?php echo esc_html__('Immediately', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr class="single_payment" data-repeater-item>
                ...
                <td>
                    ...
                    <label for="wcdp_pp_set_date"><?php echo esc_html__('Set a date', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </label>
                </td>
                <td>
            ...
            <tr>
                <td colspan="5">
                    <p> <?php echo esc_html__('Total:', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> <span id="total_percentage"> </span></p>
                </td>
            </tr>
            </tfoot>
        </table>
    ...
    function payment_plan_form_fields($term)
    {
        ...
        <tr class="form-field">
            <th scope="row"><label
                        for="amount_type"> <?php echo esc_html__('Amount Type', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></label></th>
            <td>
