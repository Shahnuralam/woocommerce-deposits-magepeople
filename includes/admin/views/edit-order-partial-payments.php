...
if ($order && $order->get_type() !== 'wcdp_payment') {
    ...
    if (!is_array($payment_schedule) || empty($payment_schedule)) {
        ?>
        <div><h4><?php echo esc_html__('No payment schedule found.', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h4></div>
        ...
        <table style="width:100%; text-align:left;">
            <thead>
            <tr>
                <th><?php echo esc_html__('Payment', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                <th><?php echo esc_html__('Date', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                <th><?php echo esc_html__('Payment method', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                <th><?php echo esc_html__('Status', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                <th><?php echo esc_html__('Amount', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
                <th><?php echo esc_html__('Actions', 'Advanced Partial Payment and Deposit For Woocommerce'); ?> </th>
