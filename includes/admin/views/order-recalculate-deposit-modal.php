        ...
        <div class="wc-backbone-modal-content">
            ...
            <section class="wc-backbone-modal-main" role="main">
                <header class="wc-backbone-modal-header">
                    <h1><?php echo esc_html__('Recalculate Deposit', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h1>
                        ...
                        <form id="wcdp-modal-recalculate-form" action="" method="post">
                            <table class="widefat">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo esc_html__('Amount Type', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></th>
                                    <th><?php echo esc_html__('Deposit', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <label>
                                            <select class="widefat wc_deposits_deposit_amount_type"
                                                ...
                                                <option <?php selected('fixed', $amount_type); ?>
                                                        value="fixed"><?php echo esc_html__('Fixed', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></option>
                                                <option <?php selected('percentage', $amount_type); ?>
                                                        value="percentage"><?php echo esc_html__('Percentage', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></option>
                                                <option <?php selected('payment_plan', $amount_type); ?>
                                                        value="payment_plan"><?php echo esc_html__('Payment plan', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></option>
                                            </select>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="3" style=" padding:30px 0 0 0; "><h3
                                                style="margin-bottom: 3px;"><?php echo esc_html__('Additional Settings', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-left:0;" colspan="2" >
                                        <label for="wc_deposits_fees_handling"><?php echo esc_html__('Fees Collection Method', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                ...
                                <tr>
                                    <td style="padding-left:0;" colspan="2"><label
                                                for="wc_deposits_taxes_handling"><?php echo esc_html__('Taxes Collection Method', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                ...
                                <tr>
                                    <td style="padding-left:0;" colspan="2"><label
                                                for="wc_deposits_shipping_handling"><?php echo esc_html__('Shipping Handling Method', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                ...
                                <tr>
                                    <td style="padding-left:0;" colspan="2"><label
                                                for="wc_deposits_coupons_handling"><?php echo esc_html__('Discount Coupons Handling', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                        ...
                        <form id="wcdp-modal-recalculate-form" action="" method="post">
                            <table class="widefat">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo esc_html__('Amount Type', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></th>
                                    <th><?php esc_html_e('Deposit', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td>
                                            <label>
                                                <select class="widefat wc_deposits_deposit_amount_type"
                                                    ...
                                                    <option <?php selected('fixed', $amount_type); ?>
                                                            value="fixed"><?php esc_html_e('Fixed', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></option>
                                                    <option <?php selected('percent', $amount_type); ?>
                                                            value="percentage"><?php esc_html_e('Percentage', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></option>
                                                    <option <?php selected('payment_plan', $amount_type); ?>
                                                            value="payment_plan"><?php esc_html_e('Payment plan', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></option>
                                                </select>
                                            </label>
                                        </td>
                                        <td style="min-width: 250px;">
                                ...
                                <tr>
                                    <td colspan="4" style=" padding:30px 0 0 0; "><h3
                                                style="margin-bottom: 3px;"><?php esc_html_e('Additional Settings', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-left:0;" colspan="3" >
                                        <label for="wc_deposits_fees_handling"><?php esc_html_e('Fees Collection Method', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                            <select name="wc_deposits_fees_handling">
                                                    <?php
                                ...
                                <tr>
                                    <td style="padding-left:0;" colspan="3"><label
                                                for="wc_deposits_taxes_handling"><?php esc_html_e('Taxes Collection Method', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                            <select name="wc_deposits_taxes_handling">
                                                    <?php
                                ...
                                <tr>
                                    <td style="padding-left:0;" colspan="3"><label
                                                for="wc_deposits_shipping_handling"><?php esc_html_e('Shipping Handling Method', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                            <select name="wc_deposits_shipping_handling">
                                                    <?php
                                ...
                                <tr>
                                    <td style="padding-left:0;" colspan="3"><label
                                                for="wc_deposits_coupons_handling"><?php esc_html_e('Discount Coupons Handling', 'Advanced Partial Payment and Deposit For Woocommerce') ?></label>
                                    </td>
                                    <td><label>
                                            <select name="wc_deposits_coupons_handling">
                                                    <?php
                ...
                <footer>
                    <div class="inner">
                        <button id="remove_deposit_data" class=" remove_deposit_data submitdelete button button-secondary button-large"><?php esc_html_e('Remove order deposit data', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></button>
                        <button id="btn-ok" class="button button-primary button-large"><?php esc_html_e('Save', 'Advanced Partial Payment and Deposit For Woocommerce'); ?></button>
                    </div>
                </footer>
            </section>
        </div>
