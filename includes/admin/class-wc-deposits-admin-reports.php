...
class WC_Deposits_Admin_Reports extends WC_Admin_Report{
	...
	public function admin_reports( $reports ){
		$reports[ 'orders' ][ 'reports' ][ 'deposits' ] = array(
			'title' => esc_html__( 'Deposits' , 'Advanced Partial Payment and Deposit For Woocommerce' ) ,
			'description' => '' ,
			'hide_title' => true ,
	...
	public function get_export_button(){
        ...
        <a
                ...
                class="export_csv"
                data-export="chart"
                data-xaxes="<?php echo esc_html__( 'Date' , 'Advanced Partial Payment and Deposit For Woocommerce' ); ?>"
                data-groupby="<?php echo $this->chart_groupby; ?>"
        >
			<?php echo esc_html__( 'Export CSV' , 'Advanced Partial Payment and Deposit For Woocommerce' ); ?>
        </a>
		<?php
	}
	...
	public function get_chart_legend(){
		...
		$legend[] = array(
			'title' => sprintf( wp_kses(__( '%s deposits in total' , 'Advanced Partial Payment and Deposit For Woocommerce' ),array('span' => array(),'strong'=> array())) ,
		...
		$legend[] = array(
			'title' => sprintf( wp_kses(__( '%s remaining in total' , 'Advanced Partial Payment and Deposit For Woocommerce' ),array('strong' => array())) ,
		...
		$legend[] = array(
			'title' => sprintf(wp_kses( __( '%s partially-paid in total' , 'Advanced Partial Payment and Deposit For Woocommerce' ),array('strong' => array()) ),
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                var drawGraph = function (highlight) {
                    var series = [
                        {
                            label: "<?php echo esc_js( esc_html__( 'Number of deposits' , 'Advanced Partial Payment and Deposit For Woocommerce' ) ) ?>",
                    ...
                    {
                        label: "<?php echo esc_js( esc_html__( 'Paid deposits' , 'Advanced Partial Payment and Deposit For Woocommerce' ) ) ?>",
                            data
                    :
                    ...
                    ,
                    {
                        label: "<?php echo esc_js( esc_html__( 'Order Remaining in Total' , 'Advanced Partial Payment and Deposit For Woocommerce' ) ) ?>",
                            data
                    :
