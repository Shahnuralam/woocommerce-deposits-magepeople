...
if(!class_exists('WCDP_Partial_Payment_Invoice')):

    class WCDP_Partial_Payment_Invoice extends Order_Document_Methods {
        /**
        ...
        public function __construct( $order = 0 ) {
            ...
            $this->title	= esc_html__( 'Partial Payment Invoice', 'Advanced Partial Payment and Deposit For Woocommerce' );
        ...
        public function get_title() {
            ...
            return apply_filters( "wpo_wcpdf_{$this->slug}_title", esc_html__( 'Partial Payment Invoice', 'Advanced Partial Payment and Deposit For Woocommerce' ), $this );
        }
    ...
    return new WCDP_Partial_Payment_Invoice();
endif;