...
class WC_Bookings_Compatibility{
    ...
    public function register_custom_post_status() {
        if ( is_admin() ) {
            ...
            register_post_status( 'wc-partial-payment', array(
                'label'                     => '<span class="status-partial-payment tips" data-tip="' . wc_sanitize_tooltip( _x( 'Partially Paid', 'Advanced Partial Payment and Deposit For Woocommerce', 'Advanced Partial Payment and Deposit For Woocommerce' ) ) . '">' . _x( 'Partially Paid', 'Advanced Partial Payment and Deposit For Woocommerce', 'Advanced Partial Payment and Deposit For Woocommerce' ) . '</span>',
                'exclude_from_search'       => false,
                'public'                    => true,
                'show_in_admin_all_list'    => true,
                'show_in_admin_status_list' => true,
                'label_count'               => _n_noop( 'Partially Paid <span class="count">(%s)</span>', 'Partially Paid <span class="count">(%s)</span>', 'Advanced Partial Payment and Deposit For Woocommerce' ),
            ) );
        }
    }
    ...
    function add_wc_partial_payment_status($statuses){
        $statuses['wc-partial-payment'] = esc_html__( 'Partially Paid','Advanced Partial Payment and Deposit For Woocommerce' );
        return $statuses;
    }
