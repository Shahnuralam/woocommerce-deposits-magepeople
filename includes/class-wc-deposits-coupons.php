...
class WC_Deposits_Coupons
{
    ...
    {
        $tabs['deposits'] = array(
            'label' => esc_html__('Deposits', 'Advanced Partial Payment and Deposit For Woocommerce'),
            ...
            <div class="options_group">
                ...
                woocommerce_wp_checkbox(
                    array(
                        ...
                        'label' => esc_html__('Disable for deposits', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'description' => esc_html__('Check this box if the coupon can be used only when customer is paying full amount', 'Advanced Partial Payment and Deposit For Woocommerce'),
                ...
                woocommerce_wp_checkbox(
                    array(
                        ...
                        'label' => esc_html__('Automatically apply for full amount', 'Advanced Partial Payment and Deposit For Woocommerce'),
                        'description' => esc_html__('Check this box if the coupon should be automatically applied in cart & checkout when customer is paying full amount', 'Advanced Partial Payment and Deposit For Woocommerce'),
    ...
    function coupon_deposit_error($err, $err_code, $coupon)
    {
        ...
        if ($deposit_in_cart && $coupon->get_meta('wcdp_disable_for_deposits') && $err_code !== 200) {
            $message = esc_html__('Coupon {coupon_code} is not valid for partial payments', 'Advanced Partial Payment and Deposit For Woocommerce');
